...
.finance-skill-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin:14px 0}.finance-skill-card{display:block;margin:0;cursor:pointer}.finance-skill-card input{position:absolute;opacity:0;pointer-events:none}.finance-skill-card>span{display:block;height:100%;border:1px solid var(--line);border-radius:13px;padding:14px;background:#fff;transition:.18s ease}.finance-skill-card input:checked+span{border-color:#93b4ff;background:#f4f7ff;box-shadow:0 0 0 2px rgba(37,99,235,.08)}.finance-skill-card b{font-size:15px}.finance-skill-card small{display:inline-flex;margin-left:8px;color:var(--brand2);background:#eaf1ff;border-radius:99px;padding:3px 7px;font-size:10px;font-weight:800}.finance-skill-card em{display:block;margin-top:7px;color:var(--muted);font-size:13px;line-height:1.55;font-style:normal}.finance-skill-catalog{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-bottom:16px}.finance-skill-info{background:#fff;border:1px solid var(--line);border-radius:14px;padding:16px}.finance-skill-info span{font-size:11px;font-weight:800;color:var(--brand2)}.finance-skill-info h3{margin:7px 0 5px;font-size:16px}.finance-skill-info p{margin:0;color:var(--muted);font-size:13px;line-height:1.55}.active-skills-card{display:flex;align-items:center;justify-content:space-between;gap:12px;background:#f7f9fd;border:1px solid var(--line);border-radius:12px;padding:10px 12px;margin-bottom:12px}.active-skills-card strong{font-size:13px;white-space:nowrap}.active-skills-card .chips{justify-content:flex-end}.skill-chip{background:#eaf1ff;color:var(--brand2)}

/* ===== Commercial landing page: financial reporting platform ===== */
.home-hero{padding:72px 0 66px;background:radial-gradient(circle at 85% 18%,rgba(37,99,235,.12),transparent 34%),linear-gradient(180deg,#fff 0%,#f7f9fd 100%);overflow:hidden}
.hero-grid{display:grid;grid-template-columns:minmax(0,1.02fr) minmax(420px,.98fr);align-items:center;gap:56px}.hero-copy{min-width:0}.eyebrow{display:inline-flex;align-items:center;color:var(--brand2);font-size:12px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;margin-bottom:14px}.eyebrow::before{content:'';width:22px;height:2px;background:var(--brand);margin-right:9px;border-radius:9px}
.hero-copy h1{font-size:48px;line-height:1.14;letter-spacing:-1.6px;margin:0 0 20px;max-width:650px}.hero-copy h1 span{display:block;color:var(--brand)}.hero-lead{font-size:18px;color:#526071;line-height:1.75;margin:0 0 20px;max-width:650px}.hero-points{list-style:none;margin:0 0 28px;padding:0;display:flex;flex-wrap:wrap;gap:10px 18px}.hero-points li{position:relative;padding-left:20px;color:#334155;font-size:14px;font-weight:650}.hero-points li::before{content:'✓';position:absolute;left:0;color:var(--ok);font-weight:900}.hero-actions{display:flex;gap:10px;flex-wrap:wrap}.hero-note{font-size:12px;color:var(--muted);margin:13px 0 0}
.product-preview{background:#fff;border:1px solid #dbe4f0;border-radius:22px;padding:20px;box-shadow:0 28px 70px rgba(30,64,175,.14),0 8px 24px rgba(15,23,42,.06);transform:rotate(1deg)}.preview-head{display:flex;justify-content:space-between;align-items:center;color:#475569;font-size:13px;border-bottom:1px solid #eef2f7;padding-bottom:14px}.preview-head>div{display:flex;align-items:center;gap:8px}.preview-head>span{color:var(--ok);font-weight:800;background:#ecfdf5;padding:3px 9px;border-radius:999px}.preview-dot{width:8px;height:8px;background:var(--brand);border-radius:50%}.preview-kpis{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin:16px 0}.preview-kpis div{background:#f8fafc;border:1px solid #eef2f7;border-radius:11px;padding:11px}.preview-kpis small{display:block;color:var(--muted);font-size:10px;margin-bottom:4px}.preview-kpis b{display:block;font-size:13px;font-variant-numeric:tabular-nums;white-space:nowrap}.positive{color:var(--ok)}.preview-chart{border:1px solid #eef2f7;border-radius:13px;padding:12px 12px 4px}.chart-label{display:flex;justify-content:space-between;color:#334155;font-size:12px;font-weight:750}.chart-label small{color:var(--muted);font-weight:500}.preview-chart svg{display:block;width:100%;height:auto;margin-top:8px}.preview-chart .area{fill:rgba(37,99,235,.1)}.preview-chart .line{fill:none;stroke:var(--brand);stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.preview-reports{display:grid;gap:7px;margin-top:12px}.preview-reports div{display:flex;justify-content:space-between;align-items:center;background:#f8fafc;border-radius:9px;padding:8px 11px;font-size:12px;color:#475569}.preview-reports b{font-size:11px;color:var(--ok)}.preview-reports b.warning{color:var(--warn)}
.trust-strip{background:#0f1f3d;color:#fff;padding:22px 0}.trust-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:18px}.trust-grid div{display:flex;align-items:baseline;gap:9px;padding-left:20px;border-left:1px solid rgba(255,255,255,.18)}.trust-grid b{font-size:22px}.trust-grid span{font-size:12px;color:#cbd5e1}
.section-intro{max-width:760px;margin:0 auto 36px;text-align:center}.section-intro .eyebrow{margin-bottom:10px}.section-intro h2{font-size:32px;line-height:1.25;margin:0 0 12px}.section-intro p{color:var(--muted);font-size:16px;line-height:1.75;margin:0}.reports-section{background:#fff}.report-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.report-card{display:flex;gap:13px;min-width:0;border:1px solid var(--line);border-radius:15px;padding:17px;background:#fff;transition:transform .18s,border-color .18s,box-shadow .18s}.report-card:hover{transform:translateY(-2px);border-color:#bfdbfe;box-shadow:var(--shadow)}.report-icon{width:38px;height:38px;flex:none;display:flex;align-items:center;justify-content:center;background:var(--brand-soft);border-radius:10px}.report-icon svg{width:21px;height:21px;fill:none;stroke:var(--brand2);stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.report-card h3{font-size:15px;margin:4px 0 5px}.report-card p{font-size:12.5px;color:var(--muted);line-height:1.6;margin:0}.live-tag{font-size:10px;font-weight:800;color:#047857;background:#ecfdf5;padding:2px 6px;border-radius:999px}.report-cta{display:flex;align-items:center;justify-content:space-between;gap:20px;margin-top:22px;padding:20px 22px;background:linear-gradient(110deg,#eff6ff,#f5f3ff);border:1px solid #dbeafe;border-radius:16px}.report-cta div{display:flex;flex-direction:column;gap:3px}.report-cta strong{font-size:16px}.report-cta span{font-size:13px;color:var(--muted)}
.capability-section{background:#f6f8fb}.cap-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.cap-card{position:relative;background:#fff;border:1px solid var(--line);border-radius:15px;padding:22px;min-height:175px}.cap-index{font-size:12px;font-weight:900;color:var(--brand);letter-spacing:.08em}.cap-card h3{font-size:17px;margin:22px 0 7px}.cap-card p{color:var(--muted);font-size:13.5px;line-height:1.7;margin:0}
.workflow-section{background:#fff}.workflow-list{list-style:none;display:grid;grid-template-columns:repeat(4,1fr);gap:0;margin:0;padding:0;border:1px solid var(--line);border-radius:18px;overflow:hidden}.workflow-list li{display:flex;gap:13px;padding:23px 20px;border-right:1px solid var(--line);background:#fff}.workflow-list li:last-child{border-right:0}.workflow-list>li>span{font-size:12px;font-weight:900;color:var(--brand);padding-top:3px}.workflow-list h3{font-size:15px;margin:0 0 7px}.workflow-list p{font-size:12.5px;color:var(--muted);line-height:1.65;margin:0}
.role-section{background:#f6f8fb}.role-grid{display:grid;grid-template-columns:.8fr 1.2fr;gap:42px;align-items:center}.role-copy h2{font-size:32px;line-height:1.25;margin:0 0 14px}.role-copy p{color:var(--muted);font-size:16px;line-height:1.75}.role-cards{display:grid;gap:10px}.role-cards article{background:#fff;border:1px solid var(--line);border-radius:14px;padding:17px 19px}.role-cards h3{font-size:15px;margin:0 0 4px}.role-cards p{font-size:13px;color:var(--muted);margin:0}
.security-band{padding:50px 0;background:#0f1f3d;color:#fff}.security-grid{display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center}.security-band .eyebrow{color:#93c5fd}.security-band .eyebrow::before{background:#60a5fa}.security-band h2{font-size:30px;line-height:1.3;margin:0}.security-band ul{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:0;padding:0;list-style:none}.security-band li{position:relative;padding:12px 12px 12px 35px;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.1);border-radius:11px;color:#e2e8f0;font-size:13px}.security-band li::before{content:'✓';position:absolute;left:13px;color:#6ee7b7;font-weight:900}.final-cta{padding:72px 0;text-align:center;background:radial-gradient(circle at 50% 10%,rgba(37,99,235,.12),transparent 38%),#fff}.final-cta h2{font-size:34px;margin:0 0 10px}.final-cta p{color:var(--muted);margin:0 0 24px}.final-cta .eyebrow{margin-bottom:12px}
@media(max-width:960px){.hero-grid{grid-template-columns:1fr;gap:36px}.product-preview{max-width:650px;margin:auto;transform:none}.report-grid{grid-template-columns:repeat(2,1fr)}.workflow-list{grid-template-columns:repeat(2,1fr)}.workflow-list li:nth-child(2){border-right:0}.workflow-list li:nth-child(-n+2){border-bottom:1px solid var(--line)}.role-grid{grid-template-columns:1fr}.trust-grid{grid-template-columns:repeat(2,1fr)}}
@media(max-width:620px){.home-hero{padding:42px 0 44px}.hero-copy h1{font-size:36px;letter-spacing:-1px}.hero-lead{font-size:16px}.hero-points{display:block}.hero-points li{margin:8px 0}.hero-actions{display:grid}.hero-actions .btn{justify-content:center}.product-preview{padding:14px;border-radius:17px}.preview-kpis{grid-template-columns:1fr 1fr}.preview-kpis div:last-child{grid-column:1/-1}.trust-strip{padding:17px 0}.trust-grid{gap:12px}.trust-grid div{display:block;padding-left:12px}.trust-grid b,.trust-grid span{display:block}.trust-grid b{font-size:18px}.section-intro{text-align:left;margin-bottom:24px}.section-intro h2,.role-copy h2{font-size:26px}.section-intro .eyebrow{justify-content:flex-start}.report-grid,.cap-grid{grid-template-columns:1fr}.report-card{padding:15px}.report-cta{display:block}.report-cta .btn{display:flex;margin-top:15px;justify-content:center}.workflow-list{grid-template-columns:1fr}.workflow-list li{border-right:0!important;border-bottom:1px solid var(--line)!important}.workflow-list li:last-child{border-bottom:0!important}.security-grid{grid-template-columns:1fr;gap:25px}.security-band ul{grid-template-columns:1fr}.final-cta{padding:54px 0}.final-cta h2{font-size:28px}}
...
.result-panel{display:none}.result-panel.active{display:block}.report-count{font-size:12px;font-weight:800;color:var(--brand2);background:var(--brand-soft);padding:4px 10px;border-radius:999px}.report-pack-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}.report-pack-grid span{display:flex;align-items:center;gap:8px;min-width:0;background:#f8fafc;border:1px solid #eef2f7;border-radius:10px;padding:10px;font-size:12px;font-weight:650;color:#475569}.report-pack-grid i{width:7px;height:7px;border-radius:50%;background:var(--ok);flex:none}
.action-grid{display:flex;flex-wrap:wrap;gap:8px;margin-top:18px}.review-tools{display:flex;align-items:flex-end;justify-content:space-between;gap:14px;margin-bottom:14px}.search-box{margin:0;flex:1;max-width:420px}.search-box span{display:block;font-size:12px;color:var(--muted);margin-bottom:5px}.filter-group{display:flex;background:#f1f5f9;padding:4px;border-radius:10px}.filter-btn{border:0;background:transparent;color:#64748b;border-radius:8px;min-height:38px;padding:7px 12px;font-weight:700;cursor:pointer}.filter-btn.active{background:#fff;color:var(--brand2);box-shadow:0 1px 3px rgba(15,23,42,.1)}
...
@media (max-width: 860px){
  .finance-skill-grid,.finance-skill-catalog{grid-template-columns:1fr}.active-skills-card{display:block}.active-skills-card .chips{justify-content:flex-start;margin-top:8px}
  ...
  .report-pack-grid{grid-template-columns:1fr 1fr}.action-grid{display:grid;grid-template-columns:1fr 1fr}.action-grid .btn{justify-content:center}.review-tools{display:block}.search-box{max-width:none}.filter-group{margin-top:10px}.filter-btn{flex:1}.review-counter{display:none}
...
<div class='nav-links'>
<a class='btn ghost' href='{P}/#reports'>报表</a>
